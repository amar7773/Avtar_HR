...
print("Audio Upload Response:", response.text)

if response.status_code!=201:
    raise Exception("Audio Uploaded Failed")
...
print("\nTalk Status:", talk_response.status_code)
print("Talk Response:", talk_response.text)

if response.status_code not in [200,201,202]:
    raise Exception("Talking Creations Avtar Failed")
